...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.centralwidget.setStyleSheet("background-color: rgba(255, 255, 255, 0.1); \n")
        ...
        sizePolicy.setHeightForWidth(
            self.path_choose.sizePolicy().hasHeightForWidth())
        ...
        self.img_choose.setGeometry(QtCore.QRect(180, 110, 100, 22))
        font = QtGui.QFont()
        font.setFamily("Rubik")
        font.setPointSize(12)
        ...
        main_functions.add_functions(ui, MainWindow)
    # setupUi

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "WM Paster"))
        self.label_name.setText(_translate(
            "MainWindow", "Выберите тип водяного знака и файл"))
